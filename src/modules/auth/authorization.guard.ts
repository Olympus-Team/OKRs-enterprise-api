...
export class AuthorizationGuard implements CanActivate {
  constructor(
    ...
    @Inject(forwardRef(() => UserService)) private readonly usersService: UserService, // @Inject(forwardRef(() => UserRoleService)) private readonly userRoleService: UserRoleService,
  ) {}
